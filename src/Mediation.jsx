    ...
    <div>
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16 relative">
        <div
          ...
          style={{
            minHeight: '500px',
            backgroundImage: "url('https://www.cancer.org/adobe/dynamicmedia/deliver/dm-aid--c705d936-4526-4d8f-a221-455a9c0a8ed5/man-meditating-outside-restricted.jpg?quality=82&width=1440&preferwebp=true  ')",
          }}
        ...
        <div className="max-w-full    mx-auto">
          <div className="mt-3 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
            <div className="bg-white relative top-0 -mt-32 p-5 sm:p-10">
              ...
              {MentalData.practiceType.map((type, index) => (
              ...
              {MentalData.techniques.map((technique, index) => (
                <div key={index} className="mb-5">
